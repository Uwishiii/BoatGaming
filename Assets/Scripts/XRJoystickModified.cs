...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRJoystickModified : XRBaseInteractable
    {
        ...
        void Start()
        {
            ...
            #region Dylan's addition
            // Set the joystick to value position
            SetHandleAngle(m_Value * m_MaxAngle);
            #endregion
        }
        ...
        private void EndGrab(SelectExitEventArgs arts)
        {
            ...
            // This is the original code, which is useless as it moves the joystick to some random previous position instead of the value position
            //UpdateValue(); 
            SetHandleAngle(m_Value * m_MaxAngle);
            #endregion
            if (m_RecenterOnRelease)
