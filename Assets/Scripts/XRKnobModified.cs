...
namespace Unity.VRTemplate
{
    ...
    public class XRKnobModified : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The starting rotation of the knob")]
        Vector3 m_StartingRotation = Vector3.zero;

        [SerializeField]
        [Tooltip("Which axis should the knob rotate")]
        ...
        {
            #region Dylan's Additions
            // Change min and max to incorporate starting rotation
            //minAngle += m_StartingRotation.z;
            //maxAngle += m_StartingRotation.z;
            #endregion
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
                ...
                m_Handle.localEulerAngles = m_StartingRotation + (m_RotationAxis * angle);
        }
